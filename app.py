...
st.markdown(f"""
    <div class="insight-box">
        ...
        <ul>
            ...
            <li><b>실제 결과:</b> 양천구(2,109개)가 2위인 강서구(1,381개)보다도 약 1.5배 이상 많으며, 최하위인 금천구(369개)와는 약 6배라는 압도적인 격차를 보임.</li>
...
st.markdown(f"""
    <div class="insight-box">
        ...
        <ul>
            ...
            <li><b>실제 결과:</b> 학원 수가 많은 구일수록 도서관 이용자 수도 비례해서 증가하는 상관관계가 관찰됨.</li>
